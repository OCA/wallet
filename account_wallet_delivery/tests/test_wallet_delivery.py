...
class TestWalletDelivery(WalletCommon):
    @classmethod
    def setUpClass(cls):
        super(TestWalletDelivery, cls).setUpClass()
    ...
    def test_wallet_sale(self):
        ...
        self.assertEqual(10.0, delivery_line.price_total)
        ...
        self.assertEqual(-7.00, self.wallet.sale_order_balance)
    ...
    def test_wallet_sale_greater(self):
        # Sale order total amount = 8850
        ...
        self.sale.apply_wallet(self.wallet)
        self.assertEqual(len(lines_before) + 1, len(self.sale.order_line))
        self.assertEqual(-500.00, self.wallet.sale_order_balance)
